...
export class CommissionsService {
  ...
  async create(dto: { title: string; description: string; price: number; clientId: string; artistId: string }) {
  ...
  async update(id: string, dto: Partial<{ title: string; description: string; price: number }>) {
